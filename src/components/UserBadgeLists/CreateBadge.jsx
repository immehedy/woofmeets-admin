...
import { createBadge } from "./lib/hooks/useCreateBadge";
import { badgeData } from "./lib/utils/formDefaultValues";
...
const CreateBadge = () => {
  ...
  return (
    <>
        ...
        <div className="text-center"><h2 className="text-[30px] text-gray-600 font-bold">Create new badge</h2></div>
        {/* Badge create form */}
